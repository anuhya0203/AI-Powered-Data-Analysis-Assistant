...
class MissingValueAgent:
    ...
    def inspect_dataset(self):
        ...
        understand which columns contain missing values.
        """
    ...
    def inspect_column(self, column):
        """
        Collect deeper information about a particular column.
        """
    ...
    def get_missing_columns(self):
        """
        Return columns that actually contain missing values.
        """
    ...
    def inspect_missingness_relationship(
        ...
        """
        Investigate whether missingness in one column
        differs across groups in another column.
        """
